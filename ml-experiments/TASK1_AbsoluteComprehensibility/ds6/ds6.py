...
class DS6:
    ...
    def __init__(self, helper, ds):
        self.helper = helper
        self.csv_data_dict = DS6.csv_data_dict
        self.ds = ds
    ...
    def evaluate(self, model, X_test, y_test, target, task):
        ...
        baseline_f1_0, baseline_f1_1, baseline_f1_2, baseline_f1_3, baseline_f1_weighted = self.getBestBaselineModel(target)
    ...
    def getBestBaselineModel(self, target):
        ...
        ## best baseline = lazy0
            ...
            baseline_f1_weighted = 0.707970348
        ...
        return baseline_0_f1, baseline_1_f1, baseline_2_f1, baseline_3_f1, baseline_f1_weighted
    ...
    def aggregate_results(self, results, target, model_name, K, hyperparam, model):
        ...
        class_metrics = {}  # Dictionary to store class-wise metrics
        y_index_all = []
        y_pred_all = []
        y_true_all = []
        y_pred_proba_all = []
        ...
        if len(unique_classes) == 2:
            ...
            # Weighted ROC AUC
            roc_auc_weighted = (negative_count / len(y_true_all)) * roc_for_negative_class + (positive_count / len(y_true_all)) * roc_for_postive_class
        ...
        ## get baseline f1 scores and class weights ##
        _,_,_,_, baseline_f1_weighted = self.getBestBaselineModel(target)
